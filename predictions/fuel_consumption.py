...
def other_transport(dist):
	vehicle_classes = {'Two-seater':22,'Subcompact':24,'Compact':26,'Midsize Sedan':26,'Large Sedan':21,'Hatchback':27,'Pickup truck':18,'Minivan':20,'Small SUV':24,'Standard SUV':18}
